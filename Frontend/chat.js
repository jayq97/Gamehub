var server = "../Backend/serviceHandler.php";
var interval = null;
function getFriends() {
    var id = $("#userId").html();
    var spinner = $("<div>");
...
function getUserByID(id, method) {
    $.ajax({
        type: "GET",
        url: server,
        cache: false,
...
function checkFRaccept(friendId) {
    var id = $("#userId").html();
    var div = $("div #" + friendId);
    var bool = false;
    $.ajax({
